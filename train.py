...
def train_model(data, params):
    ...
    print(params.vocab_msg,params.vocab_code)
    ...
    if torch.cuda.is_available():
        model = model.cuda()
        # model.load_state_dict(torch.load(params.save_dir+'/epoch_3_step_1200.pt'))
        ...
        for i, (batch) in enumerate(tqdm(batches)):
            ...
            if step % 150 ==0:
                ...
                if epoch==3:
                    ...
                    if step>150:
                        remove_path=params.save_dir+'/epoch_'+str(epoch)+'_step_'+str(step-150)+".pt"
