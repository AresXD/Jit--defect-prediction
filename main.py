...
def read_args():
    ...
    parser.add_argument('-model_type', type=str, default='BERT',
                        help='Bert type in code change,you can choose BERT,CodeBERT')
    parser.add_argument('-proj', type=str, default='qt',
                        help='Project type ,you can choose qt,op')
    ...
    if params.train is True:
        ...
        if params.cross:
            if params.proj=="qt":
                ...
                open('./data/op_data/op_test_changed.pkl', 'rb'))
                print("Cross train in qt project")
            elif params.proj=='op':
                test_data=pickle.load((open('./data/qt_data/qt_test_changed.pkl', 'rb')))
                print("Cross train in openstack project")
        ...
        data_len = len(ids)
        print(data_len)
        if params.valid != True and params.cross!=True:
        ...
        pad_msg = tokenization_for_codebert(data=msgs, max_length= params.msg_length, flag ='msg',model_type=params.model_type)
        pad_code = tokenization_for_codebert(data=codes, max_length= params.code_length, flag ='code',model_type=params.model_type)
